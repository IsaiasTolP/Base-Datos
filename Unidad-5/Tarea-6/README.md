...
# <div align="center">Consultas SQLite 6</div>

## Creando la BBDD
Entramos a la base datos creandola con `sqlite3 tarea.db` y dentro hacemos `.read base-datos-clientes.sql` y ya la tenemos preparada.
