...
# <div align="center">Consultas de expresiones regulares</div>

## Leer el fichero con nuestra BBDD
Entramos a la base datos creandola con `sqlite3 tarea.db` y dentro hacemos `.read base-datos-libros.sql` y ya la tenemos preparada.
